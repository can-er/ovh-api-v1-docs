...
| Property | Type | Required | Nullable | Read-only | Description |
|---|---|---|---|---|---|
| `serviceName` | `string` | ❌ | ❌ | ✅ | Name of the VIP offer |
| `universe` | `vip.UniverseEnum[]` | ❌ | ❌ | ✅ | VIP universes of this service |
...
_Available universe for VIP service_
